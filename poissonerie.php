...
<head>
  <meta charset="UTF-8">
  <title>Poissonneries - BHELMAR</title>
  ...
  <style>
    ...
    .card-title{color:#2980b9;font-weight:bold;}
    .btn-back{display:inline-block;margin-bottom:1rem;color:#2980b9;text-decoration:none;font-weight:bold;}
    .btn-detail{background:#2980b9;color:#fff;border:none;padding:.5rem 1rem;border-radius:8px;}
...
<div class="container">
  <h2 class="mb-4 text-center">Poissonneries locales</h2>
  <div class="row g-4">
    <?php if(empty($boutiques)): ?>
      <p>Aucune poissonnerie trouvée.</p>
