...
<head>
  <meta charset="UTF-8">
  <title>BHELMAR - Restaurant</title>
...
<div class="container mt-4">
  <h2 class="text-center mb-4">Menus du Restaurant</h2>
  <div class="row" id="liste-produits">
    ...
    <?php else: ?>
      <div class="col-12 text-center">
        <p class="text-danger">Aucun plat disponible actuellement dans cette section.</p>
      </div>
    <?php endif; ?>
  </div>
</div>
