...
<head>
  ...
  <style>
    ...
    .auth-item{text-align:center;color:#fff;margin:0 .5rem}
    .auth-item i{font-size:1.2rem}
    .auth-item span{display:block;font-size:.75rem}
    .search-form{max-width:600px;width:100%}
    .btn-search{background:#e74c3c;border:none}
    .btn-search:hover{background:#c0392b}
    .boutique-btn{margin:.5rem;color:#fff;border:none;border-radius:50px;padding:.5rem 1rem;animation:blink 1s infinite}
    ...
    .btn-access{background:#c0392b;border:none;color:#fff}
    .btn-access:hover{background:#96281b}
    footer{background:rgba(0,0,0,0.8);padding:1rem;text-align:center}
    footer a{color:#fff!important}
    .cart-item{text-align:center;color:#fff;margin:0 .5rem}
    .cart-item i{font-size:1.2rem}
    .cart-item span{display:block;font-size:.75rem}
  </style>
</head>
<body>
