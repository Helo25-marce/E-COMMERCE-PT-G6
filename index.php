...
<head>
  ...
  <style>
    ...
    .site-title, .subtitle, .nav-link, .auth-icons a { color: #fff!important; }
    ...
    .btn-access { background:#d35400; border:none; color:#fff; }
    .btn-access:hover { background:#b03a02; }
    footer {
  ...
  <nav class="navbar navbar-expand-lg custom-navbar">
    <div class="container-fluid">
      ...
      <div class="ms-auto d-flex align-items-center">
        <?php if (!$loggedIn): ?>
          <a href="login.php" class="auth-icons me-2"><i class="fas fa-sign-in-alt"></i></a>
          <a href="inscription.php" class="auth-icons me-3"><i class="fas fa-user-plus"></i></a>
        <?php else: ?>
          <a href="welcome.php" class="auth-icons me-2"><i class="fas fa-user-circle"></i></a>
          <a href="logout.php" class="auth-icons me-3"><i class="fas fa-sign-out-alt"></i></a>
        <?php endif; ?>
        <form method="GET">
